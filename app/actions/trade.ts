      ...
      .upsert(
        {
          ...
          client_order_id: clientOrderId,
          group_client_order_id: clientOrderId,
          position_idx: (market?.swap || market?.contract) ? ((orderOptions.positionIdx === 1 || orderOptions.positionIdx === 2) ? orderOptions.positionIdx : null) : null,
      ...
      try {
        await supabase
          ...
          .insert({
            ...
            position_idx: (market?.swap || market?.contract) ? (options.positionIdx ?? null) : null,
            bybit_order_id: bybitOrderId,
            status,
          });
      } catch {}
